...
typedef NS_ENUM(NSInteger, DCDTDependsSpecifierOperatorType) {
    DCDTEqualToOperatorType,
    DCDTNotEqualToOperatorType,
    DCDTGreaterThanOperatorType,
    DCDTLessThanOperatorType,
    DCDTGreaterThanOrEqualToOperatorType,
    DCDTLessThanOrEqualToOperatorType,
    DCDTBlankOperatorType,
};

@interface DCDTBaseListController : PSListController {
