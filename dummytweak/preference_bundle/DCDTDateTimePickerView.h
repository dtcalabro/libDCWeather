...
typedef NS_ENUM(NSInteger, DCDTDateTimePickerStyle) {
        DCDTDateTimePickerStyleDate,
        DCDTDateTimePickerStyleTime,
        DCDTDateTimePickerStyleTimeInterval,
        DCDTDateTimePickerStyleDateAndTime
};

@interface DCDTDateTimePickerView : UIView {
