...
@implementation DCDTDateTimePickerView
...
- (instancetype)initWithFrame:(CGRect)frame tintColor:(UIColor *)tintColor key:(NSString *)key defaultValue:(NSString *)defaultValue defaults:(NSString *)defaults postNotification:(NSString *)postNotification dateTimePickerStyle:(DCDTDateTimePickerStyle)dateTimePickerStyle {
    self = [super initWithFrame:frame];
    self.themeTintColor = tintColor;
    self.key = key;
	...
	if ([prefsDict objectForKey:self.key] != nil) {
        ...
        if (self.defaultValue != nil) {
            ...
            } else if (self.dateTimePickerStyle == DCDTDateTimePickerStyleDate) {
...
- (void)layoutSubviews {
    ...
    } else if (self.dateTimePickerStyle == DCDTDateTimePickerStyleTimeInterval) {
