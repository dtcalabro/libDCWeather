#import "DCDTHeaderCell.h"

@implementation DCDTHeaderCell
...
- (id)initWithSpecifier:(PSSpecifier *)specifier {
  ...
  if (self) {
    ...
    UIImage *headerImage = [UIImage imageWithContentsOfFile:ROOT_PATH_NS(@"/Library/PreferenceBundles/DummyTweakPrefs.bundle/DummyTweak-fullsize.png")];
