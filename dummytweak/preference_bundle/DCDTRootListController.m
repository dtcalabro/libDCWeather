...
#import "DCDTRootListController.h"
#import "DCDTBetterTitleView.h"
#import "DCDTTintedButton.h"
#import <notify.h>

@implementation DCDTRootListController
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
	...
	if ([self.navigationItem.titleView respondsToSelector:@selector(adjustLabelPositionToScrollOffset:)]) {
		[(DCDTBetterTitleView *)self.navigationItem.titleView adjustLabelPositionToScrollOffset:scrollView.contentOffset.y];
	}
}
...
- (void)setupBetterTitleView {
	...
	if (!self.navigationItem.titleView) {
		DCDTBetterTitleView *titleView = [[DCDTBetterTitleView alloc] initWithTitle:kTweakName minimumScrollOffsetRequired:20];
...
- (void)traitCollectionDidChange:(UITraitCollection *)previousTraitCollection {
    ...
    if ([self.navigationItem.titleView respondsToSelector:@selector(updateTitleColorBasedOnCurrentInterfaceStyle)]) {
		[(DCDTBetterTitleView *)self.navigationItem.titleView updateTitleColorBasedOnCurrentInterfaceStyle];
	}
}
...
- (void)setupBetterTitleView {
	...
	// Set the title and the minimum scroll offset before starting the animation
	if (!self.navigationItem.titleView) {
		DCDTBetterTitleView *titleView = [[DCDTBetterTitleView alloc] initWithTitle:kTweakName minimumScrollOffsetRequired:0];
		self.navigationItem.titleView = titleView;
	}
}
